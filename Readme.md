...
「クラスとして書くもの」に名前がある Drill は、その名前だけをクラスにしてください。`なし` の Drill は、まずは関数と dict だけで書いて大丈夫です。
...
| 0.7 | tools dict で tool を探す | なし | [drill_0_7_tool_table.py](drill_0_7_tool_table.py) |
| 0.8 | Runner をクラスにする | `FakeLLM`, `Runner` | [drill_0_8_runner_class.py](drill_0_8_runner_class.py) |
| 1 | FakeLLM で Agent ループを書く | `FakeLLM`, `Runner` | [drill_1_agent_loop.py](drill_1_agent_loop.py) |
